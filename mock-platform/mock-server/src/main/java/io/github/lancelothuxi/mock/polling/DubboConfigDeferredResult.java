...
public class DubboConfigDeferredResult extends DeferredResult {
    ...
    public DubboConfigDeferredResult(
            Long timeout, Supplier<?> timeoutResult, List<MockConfig> mockConfigs) {
        super(timeout, timeoutResult);
        subscribedConfigs.addAll(mockConfigs);
    }

    public DubboConfigDeferredResult(
            Long timeout, List<MockConfig> mockConfigs, Runnable timeoutCallback) {
    ...
    public DubboConfigDeferredResult(
            Long timeout, Supplier<?> timeoutResult, MockConfig mockConfig, Runnable timeoutCallback) {
