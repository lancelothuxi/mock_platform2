...
public class DeferredResultHolder {
    ...
    private boolean contains(List<MockConfig> subscribedConfigs, MockConfig dubboMockConfig) {
        ...
        for (MockConfig subscribedConfig : subscribedConfigs) {
            ...
            // equals
            if (stringEqualsIgnoreNull(
                    subscribedConfig.getInterfaceName(), dubboMockConfig.getInterfaceName())
                    && stringEqualsIgnoreNull(
                    subscribedConfig.getMethodName(), dubboMockConfig.getMethodName())
