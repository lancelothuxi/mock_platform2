...
public class MockDataController extends BaseController {
    ...
    public TableDataInfo list(MockData mockData) {
        ...
        MockConfig mockConfig =
                mockConfigService.selectMockConfigById(Long.valueOf(mockData.getMockConfigId()));
        startPage();
    ...
    public AjaxResult importData(MultipartFile file, MockData mockData) throws Exception {
        ...
        List<MockData> mockDatas =
                EasyExcel.read(file.getInputStream()).head(MockData.class).sheet().doReadSync();
    ...
    public AjaxResult doModifyMockTime(MockData mockData, ModelMap modelMap) {
        ...
        mockDataService.batchUpdateMockDelayTimeByMockId(
                mockData.getMockConfigId(), mockData.getTimeout());
