 ...
 * @since 1.2.0
 */
public class MockJSONPath implements JSONAware {
    static final long SIZE = 0x4dea9618e618ae3cL; // TypeUtils.fnv1a_64("size");
    static final long LENGTH = 0xea11573f1af59eb5L; // TypeUtils.fnv1a_64("length");
    ...
    public MockJSONPath(String path) {
        this(path, SerializeConfig.getGlobalInstance(), ParserConfig.getGlobalInstance(), true);
    }

    public MockJSONPath(String path, boolean ignoreNullValue) {
        this(
                path,
    ...
    public static int size(Object rootObject, String path) {
        MockJSONPath jsonpath = compile(path);
    ...
    public static MockJSONPath compile(String path, boolean ignoreNullValue) {
        if (path == null) {
            throw new JSONPathException("jsonpath can not be null");
        }
        ...
        MockJSONPath jsonpath = pathCache.get(path);
        if (jsonpath == null) {
            jsonpath = new MockJSONPath(path, ignoreNullValue);
            if (pathCache.size() < 1024) {
                pathCache.putIfAbsent(path, jsonpath);
                jsonpath = pathCache.get(path);
            }
    ...
    public static Object extract(
            String json, String path, ParserConfig config, int features, Feature... optionFeatures) {
        features |= Feature.OrderedField.mask;
        DefaultJSONParser parser = new DefaultJSONParser(json, config, features);
        MockJSONPath mockJsonPath = compile(path);
        Object result = mockJsonPath.extract(parser);
        parser.lexer.close();
        return result;
    }
    ...
    protected static boolean isInt(Class<?> clazzA) {
        return clazzA == Byte.class
                || clazzA == Short.class
                || clazzA == Integer.class
                || clazzA == Long.class;
    }
                    ...
                    if (segment instanceof PropertySegment) {
                        ...
                        if (parentBeanDeserializer != null) {
                            FieldDeserializer fieldDeserializer =
                                    parentBeanDeserializer.getFieldDeserializer(propertyName);
    ...
    public boolean setArrayItem(MockJSONPath path, Object currentObject, int index, Object value) {
        if (currentObject instanceof List) {
            List list = (List) currentObject;
            if (index >= 0) {
    ...
    @SuppressWarnings("rawtypes")
    public boolean removeArrayItem(MockJSONPath path, Object currentObject, int index) {
        if (currentObject instanceof List) {
            List list = (List) currentObject;
            if (index >= 0) {
                if (index >= list.size()) {
    ...
    protected Object getPropertyValue(
            Object currentObject, String propertyName, long propertyNameHash) {
        if (currentObject == null) {
            return null;
        }
        ...
        if (beanSerializer != null) {
            try {
                ...
                throw new JSONPathException(
                        "jsonpath error, path " + path + ", segement " + propertyName, e);
            }
        }
    ...
    protected void deepScan(
            final Object currentObject, final String propertyName, List<Object> results) {
        if (currentObject == null) {
            return;
        }
    ...
    protected void deepSet(
            final Object currentObject, final String propertyName, long propertyNameHash, Object value) {
        if (currentObject == null) {
            return;
        }
    ...
    protected boolean setPropertyValue(
            Object parent, String name, long propertyNameHash, Object value) {
    ...
    interface Segment {
        ...
        Object eval(MockJSONPath path, Object rootObject, Object currentObject);

        void extract(MockJSONPath path, DefaultJSONParser parser, Context context);
    }

    interface Filter {
        boolean apply(MockJSONPath path, Object rootObject, Object currentObject, Object item);
    }
    ...
    static class JSONPathParser {
                ...
                if (ch == '\'' || ch == '"') {
                    ...
                    if (op == Operator.RLIKE) {
                        ...
                        if (p0 == -1) {
                            ...
                            filter =
                                    new MatchSegement(
                                            propertyName, function, startsWithValue, endsWithValue, containsValues, not);
                        }
                    } else {
                        filter = new StringOpSegement(propertyName, function, strValue, op);
                    }
        ...
        Segment buildArraySegement(String indexText) {
            ...
            if (colonIndex != -1) {
                ...
                if (end >= 0 && end < start) {
                    throw new UnsupportedOperationException(
                            "end must greater than or equals start. start " + start + ",  end " + end);
                }
    ...
    static class SizeSegment implements Segment {
        ...
        public Integer eval(MockJSONPath path, Object rootObject, Object currentObject) {
            return path.evalSize(currentObject);
        }

        public void extract(MockJSONPath path, DefaultJSONParser parser, Context context) {
    ...
    static class TypeSegment implements Segment {
        ...
        public String eval(MockJSONPath path, Object rootObject, Object currentObject) {
            if (currentObject == null) {
                return "null";
            }
    ...
    static class FloorSegment implements Segment {
        ...
        public Object eval(MockJSONPath path, Object rootObject, Object currentObject) {
    ...
    static class PropertySegment implements Segment {
        ...
        public void setValue(MockJSONPath path, Object parent, Object value) {
            if (deep) {
        ...
        public boolean remove(MockJSONPath path, Object parent) {
    ...
    static class MultiPropertySegment implements Segment {
        ...
        public Object eval(MockJSONPath path, Object rootObject, Object currentObject) {
            ...
            for (int i = 0; i < propertyNames.length; i++) {
                Object fieldValue =
                        path.getPropertyValue(currentObject, propertyNames[i], propertyNamesHash[i]);
    ...
    static class ArrayAccessSegment implements Segment {
        ...
        public boolean setValue(MockJSONPath path, Object currentObject, Object value) {
            return path.setArrayItem(path, currentObject, index, value);
        }

        public boolean remove(MockJSONPath path, Object currentObject) {
            return path.removeArrayItem(path, currentObject, index);
        }

        public void extract(MockJSONPath path, DefaultJSONParser parser, Context context) {
            JSONLexerBase lexer = (JSONLexerBase) parser.lexer;
            if (lexer.seekArrayToItem(index) && context.eval) {
    ...
    static class NotNullSegement extends PropertyFilter {
        ...
        public boolean apply(MockJSONPath path, Object rootObject, Object currentObject, Object item) {
    ...
    static class IntBetweenSegement extends PropertyFilter {
        ...
        public IntBetweenSegement(
                String propertyName, boolean function, long startValue, long endValue, boolean not) {
            super(propertyName, function);
    ...
    abstract static class PropertyFilter implements Filter {
        ...
        protected Object get(MockJSONPath path, Object rootObject, Object currentObject) {
    ...
    static class RefOpSegement extends PropertyFilter {
        ...
        public boolean apply(MockJSONPath path, Object rootObject, Object currentObject, Object item) {
            ...
            if (refValue instanceof Integer
                    ...
                    || refValue instanceof Short
                    || refValue instanceof Byte) {
    ...
    public static class FilterSegment implements Segment {
        ...
        public boolean remove(MockJSONPath path, Object rootObject, Object currentObject) {
            if (currentObject == null) {
                return false;
            }
