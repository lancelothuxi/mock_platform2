...
public class MockDataServiceImpl implements IMockDataService {
    ...
    public int updateMockData(MockData mockData) {
        ...
        MockConfig mockConfig =
                mockConfigService.selectMockConfigById(Long.valueOf(real.getMockConfigId()));
        localCache.mockConfigUpdate(mockConfig);
    ...
    public int deleteMockDataByIds(String ids) {
        ...
        for (String id : array) {
            ...
            MockConfig mockConfig =
                    mockConfigService.selectMockConfigById(Long.valueOf(mockDataById.getMockConfigId()));
            localCache.mockConfigUpdate(mockConfig);
        }
    ...
    public List<MockData> selectByConfigId(String configId) {
        ...
        for (MockData mockData : mockDataList) {
            ...
            try {
                ...
                logger.error(
                        "parse mockReqParams to MockExpression list error, mockReqParams={},configId={}",
                        mockReqParams,
                        configId,
                        ex);
            }
