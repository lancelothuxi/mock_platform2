...
public class MockConfigController  {
  ...
  @Autowired private IMockConfigService mockConfigService;

  @Autowired private IMockDataService mockDataService;

  @Autowired private CommonDubboMockService commonDubboMockService;
